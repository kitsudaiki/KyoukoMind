...
echo "###########################################################################################################"
echo ""
get_required_private_repo_gitlab "libSagiriArchive" "v0.1.0" "glpat-dCkDLv96JmBscfZey4zJ" 8
...
if [ $1 = "test" ]; then
    /usr/lib/x86_64-linux-gnu/qt5/bin/qmake "$PARENT_DIR/KyoukoMind/KyoukoMind.pro" -spec linux-g++ "CONFIG += optimize_full run_tests"
    /usr/bin/make -j8
    # copy build-result and include-files into the result-directory
