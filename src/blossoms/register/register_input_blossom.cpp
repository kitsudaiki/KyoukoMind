/**
 * @file        register_input_blossom.cpp
 *
                              ...
                              std::string &errorMessage)
{
    ...
    if(size < 0)
    {
        errorMessage = "number of inputs to register must be a positive value";
        return false;
    }

    KyoukoRoot::m_ioHandler->registerInput(static_cast<uint32_t>(size));
