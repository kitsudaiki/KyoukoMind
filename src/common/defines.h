...
#define DELETE_FORWARD_EDGE_BORDER 1.0f
#define NEW_EDGE_BORDER 1.0f
#define DELETE_EDGE_BORDER 1.0f
#define NUMBER_OF_EDGE_SPLIT_PARTS 5
#define MINIMUM_NEW_EDGE_BODER 1.0f
#define LEARNING_COOLDOWN 2.0f
#define LEARNING_OFFSET 0.5f
#define MAX_SOMA_DISTANCE 5
#define MAX_ALLOWED_NODE_INPUT MAXIMUM_NODE_BODER+20

// memorizing
#define MEMORIZE_INTERVAL 20
#define ADDITIONAL_MEMORIZE_INPUT 2.0f
#define EDGE_MEMORIZE_UPDATE 0.25f
#define MEMORIZING_COOLDOWN 2.0f
