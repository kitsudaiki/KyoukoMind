               ...
               __local uchar* localBuffer)
{
    ...
    __global SynapseSection* localSynapseBuffer;
        ...
        nodeId += get_local_size(0))
    {
        ...
        localSynapseBuffer = &synapseSections[nodeId];
