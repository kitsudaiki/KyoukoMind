 ...
 */
bool
ClusterInitilizer::createNetwork()
{
 ...
 */
bool
ClusterInitilizer::addCluster(const uint32_t x,
                              const uint32_t y,
 ...
 */
bool
ClusterInitilizer::addNeighbors(const uint32_t x, const uint32_t y, Cluster* cluster)
{
    std::vector<uint8_t> sideOrder = {2,3,4,14,13,12};
    for(uint8_t i = 0; i < sideOrder.size(); i++)
    {
 ...
 */
uint32_t
ClusterInitilizer::getDistantToNextNodeCluster(const uint32_t x,
                                                        const uint32_t y,
                                                        const uint8_t side)
{
    std::pair<uint32_t, uint32_t> next = getNext(x, y, side);
...
ClusterInitilizer::getNext(const uint32_t x,
                                                         const uint32_t y,
                                                         const uint8_t side)
{
