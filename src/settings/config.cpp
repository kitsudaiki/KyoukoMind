 ...
 */
int
Config::getNumberOfThreads() const
{
    return 1;
 ...
 */
std::vector<std::string>
Config::getDatabaseConnection() const
{
 ...
 */
std::string
Config::getLogFileDirPath() const
{
    return "/tmp/";
 ...
 */
bool
Config::useStdOutputForLogging() const
{
    return false;
 ...
 */
bool
Config::useFileForLogging() const
{
    return false;
 ...
 */
bool
Config::useDatabaseForLogging() const
{
    return false;
